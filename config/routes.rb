InitialRelease::Application.routes.draw do
  ...
  mount Ckeditor::Engine => '/ckeditor'
	...
	match 'add_image' => "galeries#add_image", :as => 'add_image_galery'
	match 'del_image' => "galeries#del_image", :as => 'del_image_galery'
	match 'main_image' => "galeries#main_image", :as => 'main_image_galery'
